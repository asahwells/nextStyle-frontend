...
export function TryOnInterface({
	...
	// Helper function to convert ClothingItem to Product for cart
	...
	return (
		<div className="grid gap-6 lg:grid-cols-3">
							...
							<div className="flex flex-col gap-4">
								<div className="flex aspect-[3/4] flex-col items-center justify-center rounded-lg border-2 border-dashed border-muted-foreground/25 p-4">
									...
									<p className="text-center text-sm text-muted-foreground">
										For best results, use a full-body photo with a neutral
										background
									</p>
								</div>
							...
							<div className="mt-2 rounded-lg bg-muted p-4">
								<div className="flex items-center justify-between">
									...
									<div className="flex gap-2">
										...
										<AddToCartButton product={convertToProduct(selectedItem)} />
									</div>
								</div>
							</div>
						)}
			...
			<Dialog
				open={showBodyMeasurements}
				onOpenChange={setShowBodyMeasurements}
			>
				<DialogContent className="sm:max-w-md">
					<DialogHeader>
						<DialogTitle>Body Measurements</DialogTitle>
						<DialogDescription>
							Enter your measurements to improve the accuracy of the virtual
							try-on
						</DialogDescription>
					</DialogHeader>
					<div className="grid gap-4 py-4">
						...
						<div className="space-y-2">
							...
							<RadioGroup
								...
								onValueChange={(value) =>
									setBodyMeasurements({ ...bodyMeasurements, bodyType: value })
								}
							>
